...
# streamlit run "C:\Users\pxb08145\OneDrive - University of Strathclyde\Documents\GitHub\SEISMIC_SHIFT_demos\SEISMIC_SHIFT_demos\Showcase_app.py"
        ...
        return {
            "Current pathway": {
                ...
                "durations": {
                    ...
                    "Respiratory Referral vetting": (2, 4),
                    "Cardiology Referral vetting": (2, 4),
...
# systemsprint_page.py

import streamlit as st

def run_system_sprint():
    import streamlit as st
...
if st.session_state.page == "menu":
    ...
    st.title("NHSL Interactive Tools")
    ...
    with col1:
        if st.button("Breathlessness Pathway Simulation"):
            go_to("app")

    with col2:
        if st.button("System Sprint Stakeholder Diagram"):
            go_to("systemsprint")
...
# APP 2
# =========================================================
elif st.session_state.page == "systemsprint":
